...
return [
    ...
    'authenticationRegisterPasswordHelp' => 'Longitud mínima: ' . Core::USER_PASSWORD_MIN_LENGTH . ' caracteres. Recomenable: letras, números y símbolos.',
    ...
    'formNewEmailVerificationPending' => 'Nuevo correo electrónico (pendiente de verificar)',
    'formUserLastVisit' => 'Última visita',
    'formUserActiveSessions' => 'Sesiones abiertas',
    'formUserExpiredSessions' => 'Sesiones caducadas',
    'formUserSendEmailAgain' => 'Volver a enviar correo',
    'formUserViewSentEmails' => 'Ver correos enviados a este usuario/a',
    'errorUserNotEnabled' => 'El usuario está desactivado.',
    ...
    'globalPageNotFoundContent' => '<p>Esta dirección no existe (aún).</p><p>Puede que sea un error nuestro, pero también puede ser que hayas escrito mal la dirección, sobre todo si lo hiciste manualmente. Puedes volver a la <a href="/">portada haciendo clic aquí</a>.</p>',
    ...
    'globalPageGenericErrorTitle' => 'Algo no ha ido bien',
    'globalPageGenericErrorContent' => '<p><a href="/">Haz clic aquí para ir a la página de inicio</a>.</p>',
    ...
    'userJourneyRegistrationComplete' => 'Registro completo',
    'userJourneyPendingPasswordCreation' => 'Pendiente de crear la contraseña',
    'userJourneyEmailToCreatePasswordNotSent' => 'Correo para crear contraseña no enviado',
    'userJourneyPendingEmailVerification' => 'Pendiente de verificar correo electrónico',

    'emailConfirmationSubject' => 'Confirma tu correo electrónico',
    ...
    'emailUpdateVerificationContent' => '<p>Hola,</p>' .
        ...
        '<p>%s</p>',
    'emailPasswordChangeSubject' => 'Cambiar contraseña',
