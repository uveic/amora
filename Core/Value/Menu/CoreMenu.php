...
final class CoreMenu
{
    public static function getAdminMenu(
        ...
        return [
            ...
            new MenuItem(
                ...
                children: [
                    new MenuItem(
                        uri: UrlBuilderUtil::buildBackofficeImagesUrl($languageIsoCode),
                    ...
                    new MenuItem(
                        uri: UrlBuilderUtil::buildBackofficeArticlesUrl($languageIsoCode),
                    ...
                    new MenuItem(
                        uri: UrlBuilderUtil::buildBackofficeBlogPostsUrl($languageIsoCode),
                    ...
                    new MenuItem(
                        uri: UrlBuilderUtil::buildBackofficeUsersUrl($languageIsoCode),
            ...
            new MenuItem(
                ...
                children: [
                new MenuItem(
                    uri: UrlBuilderUtil::buildAuthorisedAccountUrl($languageIsoCode),
                ...
                new MenuItem(
                    uri: UrlBuilderUtil::buildAuthorisedLogoutUrl($languageIsoCode),
    ...
    public static function getUserMenu(
        ...
        return [
            new MenuItem(
                uri: UrlBuilderUtil::buildAppDashboardUrl($languageIsoCode),
