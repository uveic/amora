...
final class UserHtmlGenerator
{
    public static function generateUserRowHtml(
        ...
        $output[] = $indentation . '    <span><img class="img-svg m-r-05" width="20" height="20" src="/img/svg/envelope-simple.svg" alt="E-mail">' . $user->email . '</span>';
        ...
        $output[] = $indentation . '    <div><img class="img-svg m-r-05" src="/img/svg/calendar-check.svg" alt="Recibido" width="20" height="20">' .  $userDate . '</div>';
