...
readonly abstract class PublicHtmlControllerAbstract extends AbstractController
{
     ...
     * @return Response
     */
    abstract protected function getTermsAndConditionsHtml(Request $request): Response;
    ...
    private function validateAndCallGetTermsAndConditionsHtml(Request $request): Response
    {
        $errors = [];
        ...
        try {
            return $this->getTermsAndConditionsHtml(
                $request
            );
        } catch (Throwable $t) {
            Core::getDefaultLogger()->logError(
                'Unexpected error in PublicHtmlControllerAbstract - Method: getTermsAndConditionsHtml()' .
                ' Error: ' . $t->getMessage() .
                ' Trace: ' . $t->getTraceAsString()
            );
            return Response::createErrorResponse();
    ...
    public function route(Request $request): ?Response
    {
        ...
        if ($method === 'GET' &&
            ...
            return $this->validateAndCallGetTermsAndConditionsHtml($request);
        }
