    ...
    <form method="POST" id="form-password-reset">
      ...
      <div>
        ...
        <div id="password-reset-form">
          <p class="light-text-color m-b-3"><?=sprintf($responseData->getLocalValue('authenticationPasswordResetAlreadyLogin'), $baseLinkUrl)?></p>
          <div class="field">
      ...
      <div id="password-reset-success" class="field null">
        ...
        <a class="button is-success" href="<?=$this->e($baseLinkUrl)?>/login"><?=$responseData->getLocalValue('authenticationActionHomeLink')?></a>
      </div>
    </form>
  </div>
</main>
