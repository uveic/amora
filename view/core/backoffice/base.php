...
$navBarArguments = [
    ...
    'menuItems' => AppMenu::getAdmin(
        ...
        includeAuthorisedDashboardLink: false,
    ),
...
<?php } ?>
  ...
  <link href="/css/editor/trix.css?v=000" rel="stylesheet" type="text/css">
  ...
  <script src="/js/lib/trix.umd.min.js?v=2.0.8" type="text/javascript" nonce="<?=$responseData->nonce?>"></script>
</head>
<body>
