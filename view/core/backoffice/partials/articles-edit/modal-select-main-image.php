  ...
  <div class="select-media-modal modal-wrapper null">
      ...
      <div class="add-image-wrapper">
        ...
        <div class="add-image-header">
          <h1 class="m-t-0 m-b-0"><?=$responseData->getLocalValue('editorMainImageActionTitle')?></h1>
          <div>
            <input class="null" type="file" id="select-media-action-upload" name="select-media-action-upload" multiple="" accept="image/*" data-event-listener-action="selectMainImage">
        ...
        <a href="#" class="media-load-more media-load-more-js" data-type-id="<?=MediaType::Image->value?>" data-direction="<?=QueryOrderDirection::DESC->name?>" data-event-listener-action="selectMainImage">
