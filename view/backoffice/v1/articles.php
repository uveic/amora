...
?>
              <div class="table-row">
                <div class="table-item edit flex-no-grow"><a href="<?=$responseData->getBaseUrlWithLanguage()?>backoffice/articles/<?=$this->e($article->getId()); ?>"><img class="img-svg no-margin" width="20" height="20" src="/img/assets/pencil.svg" alt="<?=$responseData->getLocalValue('formGuestModifyAction')?>"></a></div>
