...
?>
  <main>
    <section class="page-header">
      <h1>Users</h1>
      <div class="links">
        <a href="<?=UrlBuilderUtil::getBackofficeNewUserUrl($responseData->getSiteLanguage())?>" class="button is-link admin-menu-button"><?=$responseData->getLocalValue('globalNew')?></a>
      </div>
    </section>
...
?>
        <div class="table-row">
          <div class="table-item edit flex-no-grow"><a href="<?=UrlBuilderUtil::getBackofficeUserUrl($responseData->getSiteLanguage(), $user->getId())?>"><img class="img-svg no-margin" width="20" height="20" src="/img/svg/pencil.svg" alt="<?=$responseData->getLocalValue('globalEdit')?>"></a></div>
