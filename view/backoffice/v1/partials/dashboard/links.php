...
?>
        <div class="content-flex-block width-45-percent">
          ...
          <p><img class="img-svg m-r-05" width="20" height="20" src="/img/svg/note-pencil.svg" alt="<?=$this->e($responseData->getLocalValue('navAdminArticles'))?>"><a href="<?=UrlBuilderUtil::buildBackofficeArticlesUrl($responseData->siteLanguage)?>"><?=$responseData->getLocalValue('navAdminArticles')?></a></p>
          <p><img class="img-svg m-r-05" width="20" height="20" src="/img/svg/article-medium.svg" alt="<?=$this->e($responseData->getLocalValue('navAdminBlogPosts'))?>"><a href="<?=UrlBuilderUtil::buildBackofficeBlogPostsUrl($responseData->siteLanguage)?>"><?=$responseData->getLocalValue('navAdminBlogPosts')?></a></p>
