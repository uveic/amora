...
?>
    <div class="form-header m-t-1 m-l-1 m-r-1">
        ...
        <div class="links">
          <a href="#" class="article-settings m-r-1"><img src="/img/svg/gear.svg" class="img-svg m-t-0" alt="Close"></a>
          <a href="<?=$responseData->getBaseUrlWithLanguage()?>backoffice/articles" class="m-r-1"><img src="/img/svg/x.svg" class="img-svg m-t-0" alt="Close"></a>
        </div>
    </div>
