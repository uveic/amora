...
?>
            <div class="table-row">
              ...
              <div class="table-item edit flex-no-grow" style="justify-content: flex-end;"><a href="<?=UrlBuilderUtil::buildBackofficeBlogPostUrl($responseData->siteLanguageIsoCode, $article->id)?>"><img class="img-svg no-margin" width="20" height="20" src="/img/svg/pencil.svg" alt="<?=$responseData->getLocalValue('globalEdit')?>"></a></div>
            </div>
<?php } ?>
      </div>
    </section>
